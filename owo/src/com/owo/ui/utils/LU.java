...
public class LU {
	...
	public static void setPadding(View v, int left, int top, int right,
			int bottom) {
		v.setPadding(left == 0 ? 0 : DimensionUtil.w(left), top == 0 ? 0
				: DimensionUtil.h(top),
				right == 0 ? 0 : DimensionUtil.w(right), bottom == 0 ? 0
						: DimensionUtil.h(bottom));
	}

	public static void setMargin(View v, int left, int top, int right,
			int bottom) {
