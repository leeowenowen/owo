...
import com.owo.ui.utils.ColorUtil;
...
public class ScrollTabControl extends LinearLayout implements
	...
	private owo_TabWidget mTabWidget;
	...
	private void initTabHost() {
		...
		mTabContent = new ViewPager(getContext());
		mTabContent.setAdapter(mPagerAdapter);
		mTabContent.setOnPageChangeListener(mOnPageChangeListener);
	...
	private int getowo_TabWidgetLocation() {
		...
		case LinearLayout.VERTICAL:
			location = (mTabContent.getLeft() < mTabWidget.getLeft()) ? owo_TabWidget_LOCATION_RIGHT
					: owo_TabWidget_LOCATION_LEFT;
			break;
		case LinearLayout.HORIZONTAL:
		default:
			location = (mTabContent.getTop() < mTabWidget.getTop()) ? owo_TabWidget_LOCATION_BOTTOM
	...
	public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
		...
		event.setClassName(ScrollTabControl.class.getName());
	}

	@Override
	public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
		super.onInitializeAccessibilityNodeInfo(info);
		info.setClassName(ScrollTabControl.class.getName());
	}
...
//		}
//		TranslateAnimation inAnimation = new TranslateAnimation(inStart, inEnd, 0, 0);
//		TranslateAnimation outAnimation = new TranslateAnimation(outStart, outEnd, 0, 0);
...
//	}
	...
	public void setCurrentTab(int index) {
		...
		mTabContent.setCurrentItem(mCurrentTab, true);
		// mTabContent.requestFocus(View.FOCUS_FORWARD);
	...
	public void onThemeChanged() {
		mSeperator.setBackgroundColor(ColorUtil.alpha(Color.BLUE));
	}
}
